            ...
            describe('Row no. for the cases:-' +(1+i),() => {
                ...
                before(async function(){
                    ...
                    contextGetVariableMethod.withArgs("request.content").returns(JSON.stringify(SendPayoutRequest_Schema.request));
                      ...
                      if("senderDetail" in SendPayoutRequest_Schema.request){
                        if(SendPayoutRequest_Schema.request.senderDetail.type == 'I'){
                            if('firstName' in SendPayoutRequest_Schema.request.senderDetail){
                                expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:name"]["ns3:givenNames"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.firstName);
                            }else{
                                expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:name"]["ns3:givenNames"]).to.be.undefined;
                            }
    
                            if('lastName' in SendPayoutRequest_Schema.request.senderDetail){
                                expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:name"]["ns3:familyName"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.lastName);
                            }else{
                                expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:name"]["ns3:familyName"]).to.be.undefined;
                            }
                        }else if (SendPayoutRequest_Schema.request.senderDetail.type == 'C'){
                            if("companyName" in SendPayoutRequest_Schema.request.senderDetail){
                                expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:legalEntityName"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.companyName);
                            }else{
                                expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:legalEntityName"]).to.be.undefined;
                            }
                        }
                    ...
                    contextGetVariableMethod.withArgs("request.content").returns(JSON.stringify(SendPayoutRequest_Schema.request));
                          ...
                          if('senderDetail' in SendPayoutRequest_Schema.request){
                              ...
                              if('cityOfBirth' in SendPayoutRequest_Schema.request.senderDetail){
                                  ...
                                  expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:birthInformation"]["ns3:cityOfBirth"]).to.not.equal('');
                  ...
                  it('ADDRESS -- AddressLine1',(done)=>{
                    ...
                    if('senderDetail' in SendPayoutRequest_Schema.request){
                      if(SendPayoutRequest_Schema.request.senderDetail.type == 'I'){
                        if('addressLine1' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:addressLine1"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.addressLine1);
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:addressLine1"]).to.be.undefined;
                        }
  
                      }else if(SendPayoutRequest_Schema.request.senderDetail.type == 'C'){
                        if('addressLine1' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:addressLine1"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.addressLine1);
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:addressLine1"]).to.be.undefined;
                  ...
                  it('ADDRESS -- AddressLine2',(done)=>{
                    ...
                    if('senderDetail' in SendPayoutRequest_Schema.request){
                      if(SendPayoutRequest_Schema.request.senderDetail.type == 'I'){
                        if('addressLine2' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:addressLine2"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.addressLine2);
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:addressLine2"]).to.be.undefined;
                        }
  
                      }else if(SendPayoutRequest_Schema.request.senderDetail.type == 'C'){
                        if('addressLine2' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:addressLine2"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.addressLine2);
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:addressLine2"]).to.be.undefined;
                  ...
                  it('ADDRESS -- AddressLine3',(done)=>{
                    ...
                    if('senderDetail' in SendPayoutRequest_Schema.request){
                      if(SendPayoutRequest_Schema.request.senderDetail.type == 'I'){
                        if('addressLine3' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:addressLine3"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.addressLine3);
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:addressLine3"]).to.be.undefined;
                        }
  
                      }else if(SendPayoutRequest_Schema.request.senderDetail.type == 'C'){
                        if('addressLine3' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:addressLine3"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.addressLine3);
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:addressLine3"]).to.be.undefined;
                  ...
                  it('ADDRESS -- City',(done)=>{
                    ...
                    if('senderDetail' in SendPayoutRequest_Schema.request){
                      if(SendPayoutRequest_Schema.request.senderDetail.type == 'I'){
                        if('city' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:city"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.city);
                        }else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:city"]).to.be.undefined;
                        }
  
                      }else if(SendPayoutRequest_Schema.request.senderDetail.type == 'C'){
                        if('city' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:city"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.city);
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:city"]).to.be.undefined;
                        }
                  ...
                  it('ADDRESS -- Country',(done)=>{
                    ...
                    if('senderDetail' in SendPayoutRequest_Schema.request){
                      if(SendPayoutRequest_Schema.request.senderDetail.type == 'I'){
                        if('country' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:country"]).to.equal(getCountryCode(SendPayoutRequest_Schema.request.senderDetail.address.country));
                        }else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:country"]).to.be.undefined;
                        }
  
                      }else if(SendPayoutRequest_Schema.request.senderDetail.type == 'C'){
                        if('country' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:country"]).to.equal(getCountryCode(SendPayoutRequest_Schema.request.senderDetail.address.country));
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:country"]).to.be.undefined;
                        }
                  ...
                  it('ADDRESS -- PostalCode',(done)=>{
                    ...
                    if('senderDetail' in SendPayoutRequest_Schema.request){
                      if(SendPayoutRequest_Schema.request.senderDetail.type == 'I'){
                        if('postalCode' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:postcode"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.postalCode);
                        }else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:postcode"]).to.be.undefined;
                        }
  
                      }else if(SendPayoutRequest_Schema.request.senderDetail.type == 'C'){
                        if('postalCode' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:postcode"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.postalCode);
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:postcode"]).to.be.undefined;
                        }
                  ...
                  it('ADDRESS -- Province',(done)=>{
                    ...
                    if('senderDetail' in SendPayoutRequest_Schema.request){
                      if(SendPayoutRequest_Schema.request.senderDetail.type == 'I'){
                        if('province' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:province"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.province);
                        }else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerIndividualIdentity"]["ns3:address"]["ns3:province"]).to.be.undefined;
                        }
  
                      }else if(SendPayoutRequest_Schema.request.senderDetail.type == 'C'){
                        if('province' in SendPayoutRequest_Schema.request.senderDetail.address){
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:province"]).to.equal(SendPayoutRequest_Schema.request.senderDetail.address.province);
                        }
                        else{
                          expect(latestRequest.parameters["ns13:createOrUpdateUserAddBeneficiaryBankAccountAndPayout"]["ns13:payerIdentity"]["ns3:payerLegalEntityIdentity"]["ns3:address"]["ns3:province"]).to.be.undefined;
                        }
